...
* Why you chose that data set.
  * In the interest of honesty, it fit the requirements of the project, and gave me a good learning curve.
* How the rows are ordered by default.
  * Ordered from 1-1000
* How you know your functions work correctly.
  * When I pushback my function through a vector and print it out, all 1000 rows come out. 
* Why you chose that calculation for your data set.
  * I chose an addition calculation because I wanted to see what the total number of views between the top 1000
  * channels were.
